...
import (
	...
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/airbrake"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/airtable/airtableoauth"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/airtable/airtablepat"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/anthropic"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/asana"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/bitbucket"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/databricks"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/datadog"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/digitalocean"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/dockerhub"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/dropbox"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/elevenlabs"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/fastly"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/figma"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/github"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/gitlab"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/groq"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/huggingface"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/jira"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/launchdarkly"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/mailchimp"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/mailgun"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/monday"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/mux"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/mysql"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/netlify"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/ngrok"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/notion"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/openai"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/opsgenie"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/plaid"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/planetscale"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/postgres"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/posthog"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/postman"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/privatekey"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/sendgrid"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/shopify"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/slack"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/sourcegraph"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/square"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/stripe"
	"github.com/etyvrox/offensiveboar/v3/pkg/analyzer/analyzers/twilio"
