...
2. Implement the `Versioner` interface. [GitHub example implementation.](https://github.com/trufflesecurity/offensiveboar/blob/2964b3b2d2edf2b60b1f71443338c6534720b67a/pkg/detectors/github/v1/github_old.go#L23))
...
3. Generate the Secret Detector
   ...
   ```
4. Add the Secret Detector to OffensiveBoar's Default Detectors

   Add the secret scanner to the [`pkg/engine/defaults/defaults.go`](https://github.com/trufflesecurity/offensiveboar/blob/main/pkg/engine/defaults/defaults.go) file like [`github.com/trufflesecurity/offensiveboar/v3/pkg/detectors/<detector_name>`](https://github.com/trufflesecurity/offensiveboar/blob/b71ea27a696bdf1c3141f637fda4ee4936c2f2d6/pkg/engine/defaults/defaults.go#L9) and 
   [`<detector_name>.Scanner{}`](https://github.com/trufflesecurity/offensiveboar/blob/b71ea27a696bdf1c3141f637fda4ee4936c2f2d6/pkg/engine/defaults/defaults.go#L1546)
...
3. Next, update the tests as necessary. A test file has already been generated by the `go run hack/generate/generate.go` command from earlier. There are 5 cases that have been generated:
   ...
   [Here is an exemplary test file for a detector which covers all 5 test cases](https://github.com/trufflesecurity/offensiveboar/blob/6f9065b0aae981133a7fa3431c17a5c6213be226/pkg/detectors/browserstack/browserstack_test.go).
